...
export const SchemeSoDocStatus = { SIGNED_BUT_NOT_SENT: "SIGNED_BUT_NOT_SENT", SIGNED_AND_SENT: "SIGNED_AND_SENT", HARD_COPY_SENT: "HARD_COPY_SENT", DOC_RECEIVED: "DOC_RECEIVED" } as const;
